...
public interface UserAttributeVerificationResultRepository {
    UserAttributeVerificationResult getUserAttributeResult(int userId, String attributeName, String docType);
    Boolean updateUserVerificationDocResult(UserAttributeVerificationResult userAttributeVerificationResult);
}
