...
public class TaxReturnDocumentProcessor extends BaseDocumentProcessor implements DocumentProcessor {
    ...
    public void processDocument(MultiValueMap<String, String> payload) {
        ...
        if (userDocument != null) {
            UserAttributeVerificationResult userAttributeVerificationResult = this.userAttributeVerificationResultRepository.getUserAttributeResult(userDocument.getUserId(), DocumentAttributesConstant.INCOME);
