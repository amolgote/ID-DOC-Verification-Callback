package com.jumio.callback.api.utils;

public class JumioPayloadConstants {
    ...
    public static final String ID_STATE_CODE = "stateCode";
    public static final String ID_ZIP = "zip";
    public static final String ID_ZIP_EXTENSION = "zipExtension";
    ...
    public static final String VERIFICATION_STATUS_APPROVED = "APPROVED_VERIFIED";
